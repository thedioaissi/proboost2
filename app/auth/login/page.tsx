...
/** Gère l'authentification d'un utilisateur via Supabase. */
    ...
    try {
      ...
      setError(
        error instanceof Error && error.message.toLowerCase().includes("invalid login credentials")
          ? "Oups, nous ne reconnaissons pas ces identifiants. Vérifiez votre email et votre mot de passe."
      ...
      <div className="w-full max-w-sm">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Connectez-vous à votre compte Probooster</CardDescription>
          </CardHeader>
          <CardContent>
